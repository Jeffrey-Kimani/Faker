...
public class Faker {
    ...
    /**
     *  Initializes the faker object with the default language as English and the default country as Kenya
     */
    public Faker() {
    ...
    /**
     * Initializes the faker object with a specified language and a specified country
     * @param language
     ...
     * @return
     * <mark>randomDigit()</mark> - <strong>9</strong>
     */
    ...
    /**
     * Generates a random digit between the minimum and the maximum
     * @param min
     * The minimum digit that can be generated
     * @param max
     * The Maximum digit that can be generated
     * @return
     * <mark>digitBetween(5,9)</mark> - <strong>7</strong>
     */
